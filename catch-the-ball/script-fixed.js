...
// Initialize the game
function init() {
    console.log("Initializing game with fixed script");
    ...
    // Create enemy bots using cylinder & sphere instead of CapsuleGeometry
    try {
        createEnemiesWithoutCapsule();
    } catch (error) {
...
// Create enemies without using CapsuleGeometry
function createEnemiesWithoutCapsule() {
    console.log("Creating enemies with cylinder & sphere instead of CapsuleGeometry");
...
window.addEventListener('load', () => {
    console.log("Loading game with fixed script");
    init();
});